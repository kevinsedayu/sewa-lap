  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mb-8 text-center">
        <h2 className="text-2xl font-bold text-indigo-800 mb-4 tracking-tight uppercase">
          Fasilitas Kami
        </h2>
        <FasilitasGallery />
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        {[
          ...
          <div key={stat.label} className={`rounded-3xl p-6 shadow-sm relative overflow-hidden group transition-all hover:scale-[1.02] hover:shadow-[0_10px_40px_rgba(49,46,129,0.6)]`} style={{ background: 'linear-gradient(135deg, #0d1b3e 0%, #162348 100%)', border: `1px solid rgba(30,45,90,0.5)` }}>
