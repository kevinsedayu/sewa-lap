...
export default function BantuanPage() {
  return (
    <div className="page-content" style={{ maxWidth: '800px', margin: '0 auto', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      {/* Hero Section */}
      <section style={{ 
        background: 'rgba(2, 44, 34, 0.65)', backdropFilter: 'blur(16px)', 
        borderRadius: '16px', 
        padding: '40px 32px',
        color: 'white',
        marginBottom: '32px',
        position: 'relative',
        overflow: 'hidden',
        boxShadow: '0 10px 40px rgba(2,44,34,0.4)',
        ...
        <div style={{
          ...
          width: '400px',
          height: '400px',
          background: 'radial-gradient(circle, rgba(16,185,129,0.2) 0%, rgba(2,44,34,0) 70%)',
          borderRadius: '50%',
          pointerEvents: 'none'
        }}></div>
      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
          ...
          <a href="https://wa.me/6281328215620" target="_blank" rel="noopener noreferrer" style={{
            ...
            background: 'rgba(2, 44, 34, 0.65)', backdropFilter: 'blur(16px)', border: '1px solid rgba(16,185,129,0.25)', borderRadius: '16px',
          ...
          onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(16,185,129,0.25)'; e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 20px rgba(2,44,34,0.3)' }}
          >
            {/* Glow */}
            <div style={{ position: 'absolute', top: '-50%', right: '-30%', width: '150px', height: '150px', background: 'radial-gradient(circle, rgba(37,211,102,0.15) 0%, rgba(2,44,34,0) 70%)', borderRadius: '50%', pointerEvents: 'none' }}></div>
          ...
          >
            {/* Glow */}
            <div style={{ position: 'absolute', top: '-50%', right: '-30%', width: '150px', height: '150px', background: 'radial-gradient(circle, rgba(225,48,108,0.15) 0%, rgba(2,44,34,0) 70%)', borderRadius: '50%', pointerEvents: 'none' }}></div>
      ...
      <section style={{ 
        ...
        borderRadius: '24px', 
        padding: '32px',
        boxShadow: '0 10px 40px rgba(2,44,34,0.3)'
      }}>
