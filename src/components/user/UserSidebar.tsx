...
const navItems = [
  ...
  { href: '/user/booking', label: 'Booking Lapangan', icon: CalendarDays },
  { href: '/user/kalender', label: 'Kalender', icon: CalendarDays },
  { href: '/user/lokasi', label: 'Lokasi Lapangan', icon: MapPin },
  { href: '/user/riwayat', label: 'Riwayat', icon: History },
  { href: '/user/keuangan', label: 'Laporan Keuangan', icon: Wallet },
